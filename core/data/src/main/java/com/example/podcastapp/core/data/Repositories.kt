...
interface WaveformRepository {
    suspend fun getWaveform(episodeId: Long): FloatArray?
    fun observeWaveform(episodeId: Long): Flow<FloatArray?>
    suspend fun saveWaveform(episodeId: Long, bars: FloatArray)
}
